module DeriGuru
    # class providing functionality for differentiating polynomials - conversion part
    class PolyDiffer
        private
        # Converts array of ratio to a differentiated polynomial string
        # @param [Array<Array>] array_of_ratio
